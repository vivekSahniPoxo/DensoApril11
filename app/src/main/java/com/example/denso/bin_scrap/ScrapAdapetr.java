...
class ScrapAdater extends RecyclerView.Adapter<ScrapAdater.TagViewHolder> {
    ...
    public ScrapAdater(Context context, WindowManager windowManager) {
    ...
    public TagViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.scrap_tag_layout, parent, false);
    ...
    public static class TagViewHolder extends RecyclerView.ViewHolder {
        ...
        TagViewHolder(View view) {
            ...
            BinID = (TextView) view.findViewById(R.id.tv_bin_id);
        }
        ...
        void setTagData(TagData data) {
            ...
            layoutParams.height = (int)(density * (singleLineHeightDp * data.getLineNumber() + dividerHeightDp * (data.getLineNumber() - 1)));
            ...
            ViewGroup.LayoutParams layoutParams1 = BinID.getLayoutParams();
            layoutParams1.height = (int)(density * (singleLineHeightDp * data.getLineNumber() + dividerHeightDp * (data.getLineNumber() - 1)));

            BinID.setLayoutParams(layoutParams1);

            // Set text to the tag
            String hexString = data.getText(); // Replace with your hexadecimal string
            ...
            System.out.println(convertedString); // Output: "Hello World"


            BinID.setText(convertedString);
        }
        ...
        void setBackgroundColor(int backgroundColor) {
            ...
            BinID.setBackgroundColor(backgroundColor);
        }
    }
